...
| M7 QA engine | Required and completed for non-UI workflow | QA includes residue, chroma-edge, clipping, drift, duplicate/static checks, component sanity checks, policy gates, approval records, suspicious renderer blocking, and a human review checklist. |
