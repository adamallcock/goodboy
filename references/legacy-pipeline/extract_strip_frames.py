...
def remove_chroma_background(
    ...
    data = bytearray()
    transparent_threshold = max(28.0, threshold * 0.30)
    opaque_threshold = max(235.0, threshold * 2.45)
    for red, green, blue in rgb.getdata():
        ...
        if green_excess > 2:
            # Generated fur commonly inherits green RGB from antialiasing at the
            # matte edge. Despill before compositing so soft fur reads neutral.
